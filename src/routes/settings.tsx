...
import { ArrowLeft, Plus, Pencil, Trash2, Save, X, Search, RefreshCw, DollarSign, Package, Bell, Users } from "lucide-react";
            ...
            {loading ? (
              ...
              filtered.map((it) => (
                <tr key={it.id} className="hover:bg-slate-50">
                  <td className="px-4 py-3 font-mono text-slate-900">{it.product_code}</td>
                  <td className="px-4 py-3 text-slate-700">{it.product_name || "—"}</td>
